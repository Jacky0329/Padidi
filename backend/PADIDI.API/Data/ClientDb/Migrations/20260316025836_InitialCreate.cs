        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerNameSnapshot = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    BuyerEmailSnapshot = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    OrderTotal = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PlacedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_orders_buyer_accounts_BuyerAccountId",
                        column: x => x.BuyerAccountId,
                        principalTable: "buyer_accounts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeSnapshot = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ColorSnapshot = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_order_line_items_quantity", "\"Quantity\" >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_product_variants_StockQuantity", "\"StockQuantity\" >= 0");
                    table.ForeignKey(
